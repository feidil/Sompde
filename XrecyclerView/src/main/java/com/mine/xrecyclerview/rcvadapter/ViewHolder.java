...
public class ViewHolder extends RecyclerView.ViewHolder {
     ...
     * @return
     */
    public ViewHolder setDif_Text(int viewId, String text) {
        TextView tv = getView(viewId);
...
//    }
    ...
    public ViewHolder setExtendAdapter(int viewId,BaseRcvAdapter adapter){
    ...
    public ViewHolder changeDraw(int viewId,int id){
        TextView tv = getView(viewId);
