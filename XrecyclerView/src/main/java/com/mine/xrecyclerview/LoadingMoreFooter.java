...
import com.mine.xrecyclerview.progressindicator.AVLoadingIndicatorView;
...
public class LoadingMoreFooter extends LinearLayout {
    ...
    public void setFootViewHeight(int height){
        mText.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,height));
    }
